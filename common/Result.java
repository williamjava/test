...
import com.tufire.common.enums.CodeEnum;
import lombok.Data;
...
public class Result<T> implements Serializable {
	...
	public static  Result generateSuccessWithMsg(String msg) {
		if(StringUtils.isEmpty(msg)){
			msg = CodeEnum.SUCCESS.getMsg();
		}
		return generateSuccessWithMsg(null,msg);
	}

	public static  Result generateSuccessWithMsg() {
		return generateSuccessWithMsg(null);
	}

	public static <T> Result<T> generateFailWithMsg(T t, String msg) {
		Result<T> result = new Result<T>();
		result.setData(t);
	...
	public static Result generateFailWithMsg(String msg) {
		if(StringUtils.isEmpty(msg)){
			msg= CodeEnum.FAIL.getMsg();
		}
		return generateFailWithMsg(null,msg);
	}

	public static Result generateFailWithMsg() {
		return generateFailWithMsg(null);
	}
